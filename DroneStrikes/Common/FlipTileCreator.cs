    ...
    public class FlipTileCreator
    {
        ...
        private static FlipTileData CreateTileData(string content, string wideContent)
        {
            var tileData = new FlipTileData()
            {
                ...
                WideBackBackgroundImage = new Uri("/Assets/Tiles/FlipCycleTileLargeEmpty.png", UriKind.Relative),
                BackgroundImage = new Uri("/Assets/Tiles/FlipCycleTileMedium.png", UriKind.Relative),
                BackBackgroundImage = new Uri("/Assets/Tiles/FlipCycleTileMediumEmpty.png", UriKind.Relative),
